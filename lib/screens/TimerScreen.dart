...
class _TimerScreenState extends State<TimerScreen> {
  ...
  void alertEndOfWork() {
    Alert(
      ...
      image: Image(
        image: AssetImage("images/resttime.png"),
        width: 150,
        height: 150,
      ),
      buttons: [
  ...
  void alertEndOfBreak() {
    Alert(
      ...
      image: Image(
        image: AssetImage("images/worktime.png"),
        width: 150,
        height: 150,
      ),
      buttons: [
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text("${toTwoDigitString(setWorkTime)} mins",
                                  style: kPreferenceTextStyle),
                              PreferenceButton(
                                  icon: Icons.add,
                                  onClick: () {
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Text("${toTwoDigitString(setRestTime)} mins",
                                  style: kPreferenceTextStyle),
                              PreferenceButton(
                                  icon: Icons.add,
                                  onClick: () {
            ...
            children: <Widget>[
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Text(getTimeString(_duration ?? _workDuration),
                          style: kTimerStyle),
              ...
              Center(
                child: Text(
                  _onBreak
                      ? "Try to have a walk or atleast stand up from your chair !"
                      : "",
                  style: kPreferenceText,
                ),
              ),
              DoroWidget(
